...
bedtools sort -i original_motifs.set148_GIAB_SV_Tier1_liftover_grch38_simple_STRchive.bed > original_motifs.set148_GIAB_SV_Tier1_liftover_grch38_simple_STRchive_sorted.bed